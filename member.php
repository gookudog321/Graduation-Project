...
?>
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                $strSQL = "SELECT * FROM member WHERE (firstname LIKE '%".$_GET["Search"]."%' ) ";
            ...
            <button type="submit" class="btn btn-light pe-7s-trash btn-danger" >ลบ</button>
            </form></div>
                                
                                            </td>
                                            <td><form action="editmember.php" method="POST">
            <input type="hidden" name="member_id"  value="<?php echo $row['member_id'];?>" class="form-control" required="required">
            <button type="submit" class="btn btn-light btn-primary" >ดูประวัติ/แก้ไข</button>
            </form></td>
                                        </tr>
        <?php } ?>
                                    </tbody>
