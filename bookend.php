            ...
            <div class="bg-white p-md-5 p-4 mb-5 border">
              <div class="row text-center">
                <div class="col-md-12 form-group" style="background-color:#FFC04D; "><br>
				  <label class="font-weight-bold "  style="color:#ffffff; font-size:25px;">จองห้องพักสำเสร็จ<br></label>
			  ...
			  <div class="row">
                ...
                <div class="col-md-12 form-group text-center">
                  ...
                  <div>เมื่อเรายืนยันการชำรเงินของคุณแล้ว สานะการจองของคุณจะเปลียนเป็น "อนุมัติ"</div>
                </div>
              </div>

              <div class="row">
                <div class="col-md-12 form-group ">
                  <label for="adults" class="font-weight-bold text-black"><a class="btn btn-primary text-white py-3 px-5" href="books_list.php"> แจ้งชำระเงิน </a></label>
          ...
          <div class="col-md-5" data-aos="fade-up" data-aos-delay="200">
            <div class="row bg-white p-md-5 p-4 mb-5 border" >
              <div class="col-md-10 ml-auto contact-info">
				<div class="family p-md-10 p-10 mb-5 border text-center"  style="background-color:#FFC04D;">นโยบายการจองห้องพัก </div>
        <div class="family"> 1 .  หลังจากการจองสำเร็จ ดำเนินการชำระเงินภายใน 5 วัน เพื่อยืนยันการจองห้อพัก</div>
        <br>
				<div>2 . การยกเลิกการจองห้องพัก หลังชำระเงินแล้วไม่สามารถขอคืนเงินได้ไม่ว่ากรณีใดๆ
