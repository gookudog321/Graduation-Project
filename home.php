...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
   ...
   Menu
          ...
          <div class="collapse navbar-collapse  " style="font-size:13px;" id="navbarResponsive">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger family" href="#booking">ค้นหาห้องพัก</a></li>
                <li class="nav-item">
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger family" href="#rooms">ดูห้องพัก</a></li>
                <li class="nav-item">
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger  family" href="#food">ร้านอาหาร</a></li>
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger family" href="#image">รูปภาพ</a>
                </li>
                <li class="nav-item">
      ...
      <form action="userbooks_form.php" method="GET">
          <div class="row">
            ...
            <div class="col-md-6 mb-3 mb-md-0 col-lg-3">
              <div class="row">
                <div class="col-md-6 mb-3 mb-md-0 family">
