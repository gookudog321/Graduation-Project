...
<div class="container">
  <div class="row">
    ...
    <div class="row text-center">
            ...
            <div class="col-md-6 mb-3 mb-lg-0 col-lg-2">
              <label for="checkin_date" class="font-weight-bold text-black family"> แจ้งจำระเงิน </label>
              <div class="field-icon-wrap">
                <div class="icon"><span class="icon-calendar"></span></div>
                <form action="booking_detail.php" method="POST">
                  <input name="id" type="hidden" value="<?php echo $row['reservation_id']; ?>">
                <button type="submit" class="btn btn-sm btn-outline-secondary family">คลิก</button>
      </form>
              </div>
            </div>
            <div class="col-md-6 mb-3 mb-lg-0 col-lg-2">
