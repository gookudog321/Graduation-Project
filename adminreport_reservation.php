                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content">
                                <form action="adminreport_reservation.php" method="GET">
                                <div class="row">
                                <div class="col-md-3">
...
<td><?php echo date_format(date_create($row['bkin']), "d/m/Y");?></td>
        ...
        <td class="text-center status<?php echo $row['status'];?>"><?php  echo $bookstatus[$row['status']]; ?></td>
        <td ><form action="adminreport_reservation.php" method="GET">
            <input type="hidden" name="id"  value="<?php echo $reservation_id;?>" class="form-control" required="required">
            <button type="submit" class="btn btn-dangeer pe-7s-trash btn-danger" >ยกเลิก</button>
            </form></td>
    </tr>
        <?php } ?>
                                    </tbody>
