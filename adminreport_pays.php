                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="content">
                                <form action="adminreport_pays.php" method="GET">
                                <div class="row">
                                <div class="col-md-3">
...
<td><?php echo date_format(date_create($row['pay_date']), "d/m/Y");?></td>
        ...
        <td ><form action="adminview_payreport.php" method="POST">
            ...
            <button type="submit" class="btn btn-dangeer pe-7s-trash btn-info" >ดูข้อมูล</button>
            </form></td>
    </tr>
        <?php } ?>
                                    </tbody>
